...
var localdb = new PouchDB('dbbaruya');
var remoteDB = new PouchDB('http://localhost:3333/dbbebas');
...
app.post('/daftar', function(request, response) {
	...
	var getDateOverwrite = "User " + getDate.toString() + " registered Successfully";
